...
opcode_entry opcode_table [512] = {
  ...
  /* 0x60 */	EX(pusha), EX(popa), EMPTY, EMPTY,//12
  ...
  /* 0x84 */	IDEXW(G2E, test, 1), IDEX(G2E, test), IDEXW(G2E, xchg, 1), IDEX(G2E, xchg),//34
  ...
  /* 0xa8 */	EMPTY, EMPTY, EMPTY, EMPTY,//test_i2a_b, test_i2a_v, stos_m_b, stos_m_v,
  /* 0xac */	EMPTY, EMPTY, EMPTY, EMPTY,//lods_m_b, lods_m_v, scas_none_b, scas_none_v,
  ...
  /* 0xc0 */	IDEXW(gp2_Ib2E, gp2, 1), IDEX(gp2_Ib2E, gp2), EMPTY, EX(ret),//group2_i_b, group2_i_v, ret_i_v, ret_v,
  /* 0xc4 */	EMPTY, EMPTY, IDEXW(mov_I2E, mov, 1), IDEX(mov_I2E, mov),
  /* 0xc8 */	EMPTY, EX(leave), EMPTY, EMPTY,
  /* 0xcc */	EMPTY, EMPTY, EMPTY, EMPTY,//int3, int_i_b, int4, iretd,
  ...
  /* 0xe8 */	IDEX(J, call), IDEXW(J, jmp, 4), EMPTY, IDEXW(J, jmp, 1),//call_rel_v, jmp_rel_v, ljmp, jmp_rel_b,
  ...
  /* 0xfc */	EMPTY, EMPTY, IDEXW(E, gp4, 1), IDEX(E, gp5),//cld, std, group4, group5
  ...
  /* 0x20 */	EMPTY, EMPTY, EMPTY, EMPTY,//mov_cr2r_l,inv , mov_r2cr_l, inv, 
  ...
  /* 0xa0 */	EMPTY, EMPTY, EMPTY, EMPTY,//inv, inv, inv, bt_r2rm_v,
  /* 0xa4 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0xa8 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0xac */	EMPTY, EMPTY, EMPTY, IDEX(E2G, imul2),//shrdi_v, inv, inv, imul_rm2r_v,
